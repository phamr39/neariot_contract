...
near call neariot_contract.testnet get_projects_funded "{}" --accountId neutrino.testnet
near call neariot_contract.testnet get_projects_watched "{}" --accountId neariot_test2.testnet
near call neariot_contract.testnet add_to_watchlist '{"id": "aGlldXRlc3QxLnRlc3RuZXRfcHJvamVjdF8xNjY4MTc3NTA0ODUyNjI2NzIx"}' --accountId neutrino.testnet 
near call neariot_contract.testnet get_user '{"user_id": "neariot_test2.testnet"}' --accountId neariot_test2.testnet 
near call neariot_contract.testnet buy_offer '{"project_id": "aGlldXRlc3QxLnRlc3RuZXRfcHJvamVjdF8xNjY4MTc3NTA0ODUyNjI2NzIx", "offer_id": "OF_1668177541972880048"}' --accountId neutrino.testnet --deposit 1
near call neariot_contract.testnet approve_project '{"id": "bmVhcmlvdF90LnRlc3RuZXRfcHJvamVjdF8xNjY4MTc2ODk3MjM5MDU4MDUy", "rate": 5, "metadata":"Approve Project, Release all money to project owner"}' --accountId neutrino.testnet
near call neariot_contract.testnet reject_project '{"id": "bmVhcmlvdF90LnRlc3RuZXRfcHJvamVjdF8xNjY4MTc2ODk3MjM5MDU4MDUy", "rate": 5, "metadata":"Reject Project, Cashback remain money to pledger"}' --accountId neutrino.testnet
